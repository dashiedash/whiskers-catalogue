<header {{ $attributes->class('bg-slate-100') }}>
  <div class="container mx-auto">
    <nav class="flex max-w-screen-xl justify-between">
      {{-- Logo --}}
      <div class="p-2">
        <a href="/">
          {{-- This is a cat logo. Don't let the monstrous code scare you. --}}
          <svg class="h-8 w-8" version="1.1" viewBox="0 0 700 700" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      {{-- Search Bar --}}
      <div class="flex justify-between p-2 py-3 px-6 space-x-6">
        <form action="" class="w-fill max-w-md">
          <div class="relative flex items-center text-gray-40">
            <svg class="absolute ml-3 h-5 w-5 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
            ...
            <input type="text" name="search" placeholder="Find Books..." autocomplete="off"
              class="w-full border-non ring-02 rounded-2xl pr-3 pl-10 py-2 text-black placeholder-gray-400 ring-gray-300 focus:ring-2 focus:ring-gray-500">
          </div>
        </form>
      </div>
      {{-- Nav Links --}}
