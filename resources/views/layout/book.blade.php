...
<body class="bg-slate-100">
  ...
  <main>
    <div class="container p-7 bg-white mx-auto my-7 rounded-lg">
      <div class="flex">
        <div class="w-1/4">
        ...
        <div class="w-3/4 px-3">
          ...
          <p class="italic text-sm text-slate-600">{{ $book->subtitle }}</p>
          ...
          <table class="m-3 table-auto text-left text-xs w-full">
            <tbody>
